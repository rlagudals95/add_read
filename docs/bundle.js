...
eval("\n\nObject.defineProperty(exports, \"__esModule\", ({\n  value: true\n}));\n\nvar dragSwitch_js_1 = __webpack_require__(/*! ./components/dragSwitch.js */ \"./src/components/dragSwitch.js\");\n\n__webpack_require__(/*! ./css/common.css */ \"./src/css/common.css\");\n\nwindow.onload = function () {\n  var drawSwitchOptions = {\n    container: document.getElementById('wrapper'),\n    htmlString: \"<button id=\\\"drawSwitch\\\">\\uC0C1\\uC790\\uADF8\\uB9AC\\uAE30</button>\",\n    x: 50,\n    y: 20\n  };\n  new dragSwitch_js_1.drawSwitch(drawSwitchOptions);\n};\n\n//# sourceURL=webpack://oop_dragndrop/./src/main.ts?");
...
eval("\n\n/* eslint-disable */\n\n/**\n * @param {string[]} pathComponents\n * @returns {string}\n */\nfunction normalizeUrl(pathComponents) {\n  return pathComponents.reduce(function (accumulator, item) {\n    switch (item) {\n      case \"..\":\n        accumulator.pop();\n        break;\n\n      case \".\":\n        break;\n\n      default:\n        accumulator.push(item);\n    }\n\n    return accumulator;\n  },\n  /** @type {string[]} */\n  []).join(\"/\");\n}\n/**\n * @param {string} urlString\n * @returns {string}\n */\n\n\nmodule.exports = function (urlString) {\n  urlString = urlString.trim();\n\n  if (/^data:/i.test(urlString)) {\n    return urlString;\n  }\n\n  var protocol = urlString.indexOf(\"//\") !== -1 ? urlString.split(\"//\")[0] + \"//\" : \"\";\n  var components = urlString.replace(new RegExp(protocol, \"i\"), \"\").split(\"/\");\n  var host = components[0].toLowerCase().replace(/\\.$/, \"\");\n  components[0] = \"\";\n  var path = normalizeUrl(components);\n  return protocol + host + path;\n};\n\n//# sourceURL=webpack://oop_dragndrop/./node_modules/mini-css-extract-plugin/dist/hmr/normalize-url.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("14318e824a7f4cae4f77")
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "oop_dragndrop:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdateoop_dragndrop"] = (chunkId, moreModules, runtime) => {
