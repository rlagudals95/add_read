...
exports.drawOptions = {
    ...
    drawOn: function () {
        ...
        var drawingSpace = document.getElementById('document');
        ...
        document.addEventListener('click', function (e) {
            ...
            if (isDraw) {
                cnt++; // 생성한 요소 갯수 카운팅
                new square_js_1.SquareComponent(drawingSpace, "<div style=\"width: 200px; height: 200px;\"><div>", _this.pos.x, _this.pos.y, cnt);
            }
            else {
